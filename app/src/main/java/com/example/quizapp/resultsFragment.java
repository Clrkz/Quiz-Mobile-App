...
public class resultsFragment extends Fragment {
    static List<Result1> services;
    private RecyclerView recyclerView;
    private GridLayoutManager gridLayout;
    private ResultAdapter1 adapter;
    String ownerID;
    String clinicID;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (conMgr.getActiveNetworkInfo() != null
            ...
            adapter = new ResultAdapter1(getActivity(), services);
        ...
        AsyncTask<Integer, Void, Void> asyncTask = new AsyncTask<Integer, Void, Void>() {
            ...
            protected Void doInBackground(Integer... movieIds) {
                ...
                Request request = new Request.Builder()
                        .url(Server.URL + "prof_result_list.php?qid="+qid)
                        .build();
                Log.e("TAG", Server.URL + "prof_result_list.php?qid="+qid);
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        Result1 services = new Result1(
                                object.getString("stdno"),
                                object.getString("Name"),
                                object.getString("score")
                        );

                        resultsFragment.this.services.add(services);
                    }
